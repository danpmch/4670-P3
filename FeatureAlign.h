...
//
// SPECIFICATION
//  int alignPair(const FeatureSet &f1, const FeatureSet &f2, const vector<FeatureMatch> &matches, MotionModel m int nRANSAC, double RANSACthresh, CTransform3x3& M);
//
// PARAMETERS
...
enum MotionModel
{
	...
	eHomography          = 1,    // images are related by a homography
};
